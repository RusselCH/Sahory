...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para mi PRINCESA SAHORY SELENE:\n\nA veces me doy cuenta de que pensarte
tiene algo de calma rara,
como cuando el día baja el ruido
y todo se siente un poco más ligero.\n\nY también entendí algo contigo:
no hace falta que sea una fecha especial
para decirte algo bonito,
porque cuando alguien es tan especial como tú,
cualquier día parece perfecto para recordártelo✨.`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con todo mi amor , tu Gatito😺😸😼";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2022-01-21T00:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2026-03-21T00:00:00');
